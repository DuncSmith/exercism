...
class PhoneNumberTest < Minitest::Test # rubocop:disable ClassLength
  ...
  def test_cleans_number_when_only_opening_parenthesis
    number = PhoneNumber.new('(123 456-7890').number
    assert_equal '1234567890', number
  end

  def test_cleans_number_when_only_closing_parenthesis
    number = PhoneNumber.new('123) 456-7890').number
    assert_equal '1234567890', number
  end

  def test_cleans_number_when_parenthesis_and_dot
    number = PhoneNumber.new('(123).456-7890').number
    assert_equal '1234567890', number
  end

  def test_cleans_number_when_parenthesis_and_space_and_dot
    number = PhoneNumber.new('(123) .456-7890').number
    assert_equal '1234567890', number
  end

  def test_cleans_number_when_parenthesis_and_dot_and_space
    number = PhoneNumber.new('(123). 456-7890').number
    assert_equal '1234567890', number
  end

  def test_cleans_number_when_dots_and_hyphens
    number = PhoneNumber.new('123-.456.-.7890').number
    assert_equal '1234567890', number
  end

  def test_cleans_number_when_parenthesis_and_dots_and_hyphens
    number = PhoneNumber.new('(123)..456--7890').number
    assert_equal '1234567890', number
  end

  def test_cleans_number_with_leading_white_space
    number = PhoneNumber.new('    1234567890').number
    assert_equal '1234567890', number
  end

  def test_cleans_number_with_trailing_white_space
    number = PhoneNumber.new('1234567890   ').number
    assert_equal '1234567890', number
  end

  def test_cleans_number_with_leading_and_trailing_white_space
    number = PhoneNumber.new(" \t 1234567890  \t").number
    assert_equal '1234567890', number
  end
